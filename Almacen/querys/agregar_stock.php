...
//registra el ingreso de stock
if ($id_pedido != null || $id_productos != null || $id_proveedor != null || $nombre != null || $total_stock != null || $total != null || $fecha_ingreso != null || $hora_ingreso != null) {
    $sql = "INSERT INTO pedidos (id_pedido, id_producto,id_proveedor , nombre_producto, cantidad_ingreso, total_pedido, fecha_ingreso, hora_ingreso) VALUES ('" . $id_pedido . "','" . $id_productos . "','".$id_proveedor."','" . $nombre . "','" . $cantidad . "','".$total."','" . $fecha_ingreso . "','" . $hora_ingreso . "')";
