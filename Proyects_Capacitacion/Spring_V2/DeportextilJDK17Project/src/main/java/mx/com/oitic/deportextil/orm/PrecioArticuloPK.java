...
public class PrecioArticuloPK implements Serializable {
    ...
    public PrecioArticuloPK(String idTipoArticulo, String idListaPrecio) {
    ...
    public String toString() {
        return "mx.com.oitic.deportextil.orm.PrecioArticuloPK[ idTipoArticulo=" + idTipoArticulo + ", idListaPrecio=" + idListaPrecio + " ]";
    }
